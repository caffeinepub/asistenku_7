      ...
      <main className="container mx-auto px-6 py-12">
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="mb-6 grid w-full grid-cols-2 gap-2 md:grid-cols-4">
            <TabsTrigger value="ringkasan">Ringkasan AM</TabsTrigger>
            <TabsTrigger value="performa">Performa</TabsTrigger>
            <TabsTrigger value="eskalasi">Eskalasi</TabsTrigger>
